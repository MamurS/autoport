...
import { ArrowLeft, MapPin, Clock, Users, Car, Star, StickyNote, Navigation } from 'lucide-react'
...
export default function RideDetail() {
  ...
  useEffect(() => {
    ...
    const fetchReviews = async () => {
      ...
      // Fetch reviews for the driver of this ride
      ...
      if (rideData?.driver_id) {
        const { data } = await supabase
          ...
          .eq('reviewee_id', rideData.driver_id)
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        {ride.driver && (
          <Card>
            <CardHeader>
              <h3 className="text-sm font-semibold text-gray-900">{t('rides.driver')}</h3>
            </CardHeader>
            <CardContent>
